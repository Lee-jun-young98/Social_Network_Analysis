...
## 1페이지부터 10페이지까지
  for (k in 3:12) {
    ...
    ## 편입종목상위 1페이지에 들어감
    remDr$findElement(using = 'xpath', value = paste0("/html/body/div/table[2]/tbody/tr/td[12]/a"))$clickElement()
    
    ## 삼성전자 차트에 들어감
    remDr$findElement(using = 'xpath', value = paste0("/html/body/div/table[1]/tbody/tr[",k,"]/td[1]/a"))$clickElement()
